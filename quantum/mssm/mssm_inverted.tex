...
\begin{tikzpicture}[inverted,
  ...
  squark/.style   = {diamond  , white, draw, fill=yellow , minimum width=2.3em, text centered, minimum height=2.3em, inner sep=0pt},
  slepton/.style  = {diamond  , white, draw, fill=red!50 , minimum width=2.3em, text centered, minimum height=2.3em, inner sep=0pt},
  gaugino/.style  = {rectangle, white, draw, fill=green  , minimum size=2em   , text centered, minimum height=2em  , inner sep=0pt},
  higgsino/.style = {rectangle, white, draw, fill=blue!40, minimum width=2em  , text centered, minimum height=2em  , inner sep=0pt},
  ]
