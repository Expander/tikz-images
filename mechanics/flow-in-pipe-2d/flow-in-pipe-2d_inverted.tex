...
% Flow inside a 2-dimensional pipe
%
...
% given by
%
% \vec{v}(r,z) = v_0[d_1/d_2(z)\vec{e}_z+d_1d_2'(z)r/d_2^2(z)\vec{e}_r]
...
\begin{tikzpicture}[inverted,inverted]
  ...
  \begin{axis}[inverted,
    ...
    declare function={
      ...
      vz(\z,\r) = inside(\z, \r)*\diamA/diam(\z);
      % radial component of velocity
      vr(\z,\r) = inside(\z, \r)*(\diamA*dprime(\z)/diam(\z)^2)*\r;
    ...
    % pipe
    \draw[white, very thick] (0,{\diamA/2}) -- ({\Length},{\diamA/2}) -- ({2*\Length},{\diamC/2}) -- ({3*\Length},{\diamC/2});
    \draw[white, very thick] (0,{-\diamA/2}) -- ({\Length},{-\diamA/2}) -- ({2*\Length},{-\diamC/2}) -- ({3*\Length},{-\diamC/2});
    % labels
