...
\begin{axis}[inverted,
  ...
  % pipe
  \addplot3[white, very thick, domain=0:1, samples=2] ({x},{1},{0});
  \addplot3[white, very thick, domain=1:2, samples=2] ({x},{(3-x)/2},{0});
  \addplot3[white, very thick, domain=2:3, samples=2] ({x},{0.5},{0});
  \addplot3[white, very thick, domain=0:1, samples=2] ({x},{-1},{0});
  \addplot3[white, very thick, domain=1:2, samples=2] ({x},{-(3-x)/2},{0});
  \addplot3[white, very thick, domain=2:3, samples=2] ({x},{-0.5},{0});
  % labels
  ...
  % \draw[gray,dashed,thin] (1,1) -- (1,-1);
  % \draw[gray,dashed,thin] (2,0.5) -- (2,-0.5);
\end{axis}
\end{tikzpicture}
\end{document}
